...
def FCmapCompute(bold_file, lesion_file, mni_mask):
    ...
    lesion_local_data = np.tile(lesion_data_shape, bold_data.shape[1])
    r_map = compute_fr_fz(lesion_local_data, bold_data)
    ## define out_name
...
if __name__ == '__main__':
    ...
    bold_files = glob('xcp_d/sub-20240930/func/sub-*_space-MNI152NLin6Asym_res-2_desc-denoised_bold.nii.gz')
