...
if __name__ == '__main__':
    ...
    df_simple.to_csv(os.path.join('Results','glm_gm', 'simple', 'Beta_group_Results.csv'), header=True, index=None)
    ...
    df_simple.to_csv(os.path.join('Results','glm_gm', 'simple', 'Zmap_group_Results.csv'), header=True, index=None)
