...
def beta_extract_ind(mask):
    ...
    beta_file = os.path.join('Results/glm/simple/beta_files', sub_name, 'beta_' + sub_pos + '.nii.gz')
...
def zmap_extract_ind(mask):
    sub_name, sub_pos, mask_size = get_mask(mask)
    zmap_file = os.path.join('Results/glm/simple/zmap_files', sub_name, 'zmap_' + sub_pos + '.nii.gz')
...
if __name__ == '__main__':
    ...
    df_simple.to_csv(os.path.join('Results','glm', 'simple', 'Beta_Individual_Results.csv'), header=True, index=None)
    ...
    df_simple.to_csv(os.path.join('Results','glm', 'simple', 'Zmap_Individual_Results.csv'), header=True, index=None)
