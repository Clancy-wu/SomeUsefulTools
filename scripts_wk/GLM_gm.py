...
def map_compute_stand(file):
    ...
    # zmap
    z_map_dir = os.path.join('Results/glm_gm_ica/zmap_files', motion_file_sub)
    ...
    # beta
    beta_map_dir = os.path.join('Results/glm_gm_ica/beta_files', motion_file_sub)
...
if __name__ == "__main__":
    ...
    # start
    glm_dir = 'Results/VolumeFilter_ica'
